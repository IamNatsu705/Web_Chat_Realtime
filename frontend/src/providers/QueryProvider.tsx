      ...
      new QueryClient({
        defaultOptions: {
          queries: {
            ...
            refetchOnMount: true, // Ép buộc gọi lại API ở lần mount đầu tiên của component nếu dữ liệu đã bị đánh dấu là stale. Fix bug: Thiếu số đếm thông báo toàn cục (global counters) khi khởi động app.
          },
        },
      })
  );
