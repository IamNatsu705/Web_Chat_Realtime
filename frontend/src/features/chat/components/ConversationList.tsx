...
export default function ConversationList({
  ...
  // ── Filter cho tab Tin nhắn / Người lạ ───────────────────────────────────
  const filtered = conversations.filter((c) => {
    ...
    if (c.is_group) return (c.name ?? '').toLowerCase().includes(q);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-3 border-b border-gray-200 flex-shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg text-xs placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 transition"
          />
        </div>
        ...
        <div className="flex w-full mt-2 border-b border-gray-200">
          {[
            ...
            <button
              ...
              className={`flex-1 pb-1.5 text-[11px] font-medium border-b-2 transition-colors ${
                tab === key
      ...
      <div className="flex-grow overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-36 text-gray-400 text-xs px-4 text-center">
