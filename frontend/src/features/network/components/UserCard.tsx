          ...
          {user.relationship_status === RELATIONSHIP_STATUS.ACCEPTED && (
            <div className="flex space-x-2 w-full">
              <button
                ...
                disabled={isProcessing}
                className="flex-[2] py-2 border border-[#D70038] text-[#D70038] font-bold rounded-full hover:bg-[#D70038] hover:text-white transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
                <svg className="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
